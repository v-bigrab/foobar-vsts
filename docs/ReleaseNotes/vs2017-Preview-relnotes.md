...
##<a id="15.4.0"></a>Release Date: August 24, 2017 - Visual Studio 2017 version 15.4.0 Preview 1

### What's New in this Release

* [Tools for Universal Windows Platform development](#uwp)
* [Visual Studio Tools for Xamarin](#xamarin)
* [Visual Studio Improvements](#VSIDE)
* [Linux C++](#LinuxC++)
...
Visual Studio 2017 version 15.4 Preview brings first class support for developers targeting the Windows Fall Creators Update SDK preview. To install the latest Windows Fall Creators Update SDK preview, you need to become a [Windows Insider](https://insider.windows.com/). Insiders can install the SDK previews [here](https://www.microsoft.com/software-download/windowsinsiderpreviewSDK).
...
#### <a id="xamarin">Visual Studio Tools for Xamarin</a>
...
#### <a id = "VSIDE">Visual Studio Improvements</a>
...
* #### Issue:
The XAML Designer is disabled for UWP projects with a min version target of the Fall Creators Update SDK Preview.

* #### Workaround:
Set your minimum version to the Creators Update SDK (10.0.15063.0). If you want to use .NET Standard 2.0 with UWP development, there is currently no workaround to this issue.
...
### <a id="KIRTools"> </a>R Language Support
* #### Issue:
...
Previous releases: To understand the Visual Studio 2017 Release cadence visit the Release Rhythm document.
